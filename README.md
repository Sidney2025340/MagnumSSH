...
**MagnumSSH** é um gerenciador de usuários SSH leve e eficiente, desenvolvido em Rust. Com ele, você pode criar, remover e administrar usuários SSH de forma simples e segura.
...
Se você estiver desenvolvendo ou quiser entender melhor as funcionalidades do MagnumSSH, aqui está a documentação dos comandos disponíveis. Você pode visualizar essa documentação usando a opção `--help`:

```bash
/opt/magnumssh/manager --help
```
...
https://t.me/magnumssh

## Suporte
https://t.me/magnumsshgroup
