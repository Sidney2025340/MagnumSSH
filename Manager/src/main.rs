...
fn main() {
    let sqlite_conn = Connection::open("/opt/magnumssh/db").unwrap();
...
fn connection_menu(sqlite_conn: &Connection) {
    loop {
        ...
        println!("| 2 - {:<40} |", "MagnumProxy (ws/wss/socks)");
...
fn proxy_menu(sqlite_conn: &Connection) {
    loop {
        ...
        println!("------------------------------------------------");
        println!("|                  {}                 |", text_to_bold("MAGNUM PROXY"));
        println!("------------------------------------------------");
...
fn sslproxy_menu(sqlite_conn: &Connection) {
    loop {
        ...
        println!("------------------------------------------------");
        println!("|                  {}              |", text_to_bold("MAGNUM PROXY SSL"));
        println!("------------------------------------------------");
        let conn = get_connections(&sqlite_conn).unwrap();
